<?php
  ...
  if (isset($_POST['register'])) {
    if (strlen($_POST['txtName']) >= 1 && strlen($_POST['txtLastName']) >= 1 && strlen($_POST['txtAge']) >= 1 && strlen($_POST['txtPhoneNumber']) >= 1 && strlen($_POST['txtEmail']) >= 1) {
        ...
        $query = "INSERT INTO persona (name, lastname, age, phonenumber, email) VALUES  ('$name','$lastName', '$age', '$phoneNumber', '$email')";
    ...
    $con = new Conection();
    $registro = $con->ObtenerDatos();

    include('views/personasView.php');
